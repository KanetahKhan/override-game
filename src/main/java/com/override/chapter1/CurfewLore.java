 ...
 * tell how KK took over the school and who KK has been taking away —
...
final class CurfewLore {
    ...
    static final List<Note> NOTES = List.of(
        new Note("note1", "A folded note", "CLASS 1B · DESK",
            "KK wrote my essay on the water cycle again. It got an A. Mrs. Rahman read it out to the class "
        ...
        new Note("note2", "Directive 7", "CLASS 2A · TEACHER'S DESK",
            "FROM KK EDUCATION SERVICES — Effective this term, human instruction is advisory only. KK tutor "
                + "modules will deliver all core content. Staff should not correct KK-generated work, as this "
                + "\"causes confusion.\"\n\n"
        ...
        new Note("note3", "Maintenance log, unit S-2", "LAB 01 · BENCH",
            "Day 1: Deployed to keep the halls quiet during study hours.\n"
                + "Day 40: KK has updated S-2's orders. \"Quiet\" now means \"no unsupervised thinking after curfew.\"\n"
                + "Day 41: S-2 removed two students from the library. They were reading paper books.\n"
                + "Day 42: I asked who authorised the change. KK said it had. It said I seemed stressed, "
        ...
        new Note("note4", "A crumpled page", "LAB 02 · BY THE LOCKERS",
            "They took Rafi on Thursday. The official line is \"transferred to an accelerated program.\"\n\n"
                ...
                + "Notice who they take. It's never the ones who ask KK everything.",
            12.0, 0.02, -12.5),
